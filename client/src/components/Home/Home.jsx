...
import {
    ...
    applyOrder,
    applyActivity,
    applyRefresh} from '../../redux/actions'
...
<div>
    ...
    <button className={navigation.page1 > 0 ? 'navBoton' : 'hidden_navBoton'} name='all_back' onClick={handlePagination}>&#x276E;&#x276E;</button>
    ...
    <button className={navigation.page2 < filteredCountries.length ? 'navBoton' : 'hidden_navBoton'} name='all_forward' onClick={handlePagination}>&#x276F;&#x276F;</button>
    </div>
    }
